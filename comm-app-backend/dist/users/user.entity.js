...
__decorate([
    (0, typeorm_1.OneToMany)(() => document_entity_1.Document, (d) => d.owner),
    __metadata("design:type", Array)
], User.prototype, "documents", void 0);
__decorate([
    (0, typeorm_1.OneToMany)(() => document_share_entity_1.DocumentShare, (s) => s.user),
    __metadata("design:type", Array)
], User.prototype, "documentShares", void 0);
