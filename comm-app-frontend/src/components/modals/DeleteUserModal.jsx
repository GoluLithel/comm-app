...
export default function DeleteUserModal({ name, onCancel, onConfirm }) {
  return (
    <>
      ...
      <h3 style={{ margin: '0 0 7px', fontSize: 19, fontWeight: 800 }}>Delete user</h3>
      <p style={{ margin: '0 0 22px', color: '#767c99', fontSize: 14.5, lineHeight: 1.55 }}>
        Are you sure you want to remove <b style={{ color: '#232842' }}>{name}</b>? This action can't be undone.
      </p>
